...
export const serialize = <T>(data: T): Serialized<T> => superjson.serialize(data) as never as Serialized<T>;

export const deserialize = <T>(data: Serialized<T>): T => superjson.deserialize(data as never as SuperJSONResult);
