...
export function EnvInformation() {
  ...
  const prLink = `${PublicWebAppConfig.repository}/pulls?q=${encodeURIComponent(`is:pr head:${branch}`)}`;
      ...
      <div className="fr-container">
        <div className="fr-notice__body">
          <p className="fr-notice__title">
            Ceci est la version &#34;{branch}&#34; de {PublicWebAppConfig.projectTitle} présentant des données de démonstration.
          </p>
          <p className="fr-text--sm">
            <a href={prLink} className="fr-mr-2w" rel="noreferrer" target="_blank">
              <span className="fr-icon--sm fr-icon-github-fill" /> PR &#34;
              {branch}&#34; sur Github
            </a>
            <br className="fr-hidden-lg fr-mt-2v" />
            <a href={storybookLink} className="fr-mr-2w" rel="noreferrer" target="_blank">
            ...
            <a href={PublicWebAppConfig.mainLiveUrl} target="_blank">
              <span className="fr-icon--sm fr-icon-france-line" /> Version officielle
            </a>
            <br className="fr-hidden-lg fr-mt-2v" />
          </p>
        </div>
