        ...
        >
          ...
          >
            <div className={fr.cx('fr-col-12', 'fr-col-lg-8', 'fr-col-offset-lg-1')}>
              <h1 style={{ color: '#000091' }}>
                Un accompagnement gratuit pour vos projets de transition écologique, de numérique ou de revitalisation du territoire
              </h1>
              <p>
                Nous mettons gratuitement à votre disposition des conseillers pour vous accompagner dans la réalisation de votre projet, le plus en
                amont possible.
              </p>
              <Button
                linkProps={{
                  href: 'https://calendly.com/etudes-incubateur-anct/prenez-un-rendez-vous-gratuit-avec-un-conseiller',
                }}
              >
